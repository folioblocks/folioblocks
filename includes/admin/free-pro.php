...
if (! function_exists('fbks_get_free_pro_sections')) {
	function fbks_get_free_pro_sections()
	{
		return array(
			array(
				'title' => __('Page & Post Settings', 'folioblocks'),
				'rows'  => array(
					array('feature' => __('Password Protect Pages & Posts', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Page-Level Lazy Load Controls', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Page-Level Disable Right-Click Controls', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
				),
			),
			array(
			...
			array(
				...
				'rows'  => array(
					...
					array('feature' => __('Block Transforms between FolioBlocks photo galleries', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					...
					array('feature' => __('Link images to media files', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link images to custom URLs', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link images to pages or posts', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link Target Icon for WooCommerce, downloads, custom URLs, and pages/posts', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Lightbox', 'folioblocks'), 'free' => '✅', 'pro' => '✅'),
					array('feature' => __('Lightbox Appearance: Light & Dark', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Full-Screen Lightbox', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Lightbox Content: title, caption, EXIF data, product info, and combined layouts', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Per-Image Click & Hover Setting Overrides', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Overlay Content: title, caption, product info, or EXIF data', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					...
					array('feature' => __('Custom Image Click Icon Styles', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Overlay Styles', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					...
					array('feature' => __('Drop Shadow Effect on Images (Subtle, Soft, Elevated, & Dramatic)', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
				),
			),
			array(
				...
				'rows'  => array(
					...
					array('feature' => __('Per-Image Click & Hover Setting Overrides', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Overlay Content: title, caption, product info, or EXIF data', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Hover Overlays (Blur, Fade, Gradient, Chip, & Color)', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Disable Right-Click', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Lazy Load', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Image Click Icon Styles', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
				),
			...
			array(
				...
				'rows'  => array(
					...
					array('feature' => __('Enable Image Downloads', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link to store products with WooCommerce Integration', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link image to media file', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link image to custom URL', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link image to page or post', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Link Target Icon for WooCommerce, downloads, custom URLs, and pages/posts', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Disable Right-Click', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Lazy Load', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('EXIF metadata fields in the Image Block inspector', 'folioblocks'), 'free' => '✅', 'pro' => '✅'),
					array('feature' => __('Sync Image Metadata to the WordPress Media Library', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Lightbox', 'folioblocks'), 'free' => '✅', 'pro' => '✅'),
					array('feature' => __('Lightbox Appearance: Light & Dark', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Full-Screen Lightbox', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Lightbox Content: title, caption, EXIF data, product info, and combined layouts', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					...
					array('feature' => __('Custom Image Click Icon Styles', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Overlay Styles', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Custom Border & Border Radius on Images', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Drop Shadow Effect on Images (Subtle, Soft, Elevated, & Dramatic)', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
				),
			),
			array(
			...
			array(
				...
				'rows'  => array(
					...
					array('feature' => __('Overlay Content: Play Button, Video Title, or Both', 'folioblocks'), 'free' => '✅', 'pro' => '✅'),
					array('feature' => __('Custom Hover Overlay Styles', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					...
					array('feature' => __('Lightbox Appearance: Light & Dark', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
					array('feature' => __('Full-Screen Video from Lightbox', 'folioblocks'), 'free' => '❌', 'pro' => '✅', 'free_unavailable' => true),
