...
export default function Edit({ clientId, attributes, setAttributes }) {
	const { columns, tabletColumns, mobileColumns, lightbox, preview } =
		attributes;
	...
	const activeFilter = fbksNormalizeActiveFilterValue(attributes.activeFilter);
	...
	return (
		<>
			...
			<InspectorControls group="styles">
				...
				{applyFilters("folioBlocks.masonryGallery.iconStyleControls", null, {
					attributes,
					setAttributes,
				})}
			</InspectorControls>
			...
			>
				...
				{!isLoading && innerBlocks.length === 0 ? (
					...
					<>
						{applyFilters("folioBlocks.masonryGallery.renderFilterBar", null, {
							attributes,
							setAttributes,
						})}
