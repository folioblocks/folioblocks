...
export function getFontWeightOptions( families, __ ) {
	...
	const options = [
		{ label: __( 'Theme Default', 'folioblocks' ), value: '' },
	];
 ...
 * @param normalizedFontSizes
 */
export function getFontSizeOptions( normalizedFontSizes ) {
	const safe = Array.isArray( normalizedFontSizes )
		? normalizedFontSizes
		: [];
	...
	return themeFontSizeOptions.length
