		...
		return (
			<>
				<SelectControl
					...
					help={__(
						'Choose how the video thumbnail moves or changes on hover.',
						'folioblocks'
					)}
					__nextHasNoMarginBottom
					__next40pxDefaultSize
				...
				<SelectControl
					...
					help={__(
						'Choose how overlay content enters the thumbnail.',
						'folioblocks'
					)}
					__nextHasNoMarginBottom
					__next40pxDefaultSize
...
addFilter(
	...
	(defaultContent, { attributes, setAttributes, isInsideGallery }) => {
		...
		if (isInsideGallery || (!isColorOverlay && !isGradientOverlay)) {
			return null;
		}
